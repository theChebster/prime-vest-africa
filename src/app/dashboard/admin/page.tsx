...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    // We will create this API next to fetch system totals
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white p-6 lg:p-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        ...
        <StatCard title="System Liability" value={`GHS ${stats.totalBalance.toLocaleString()}`} icon={<Landmark className="text-yellow-500" />} />
